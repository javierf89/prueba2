    ...
    carrito.addEventListener('click', async function(event) {
        ...
        if (docSnap.exists() && docSnap1.exists()) {
            ...
            querySnapshot.forEach((doc) => {
                if (doc.id === 'Celular2') {
                    ...
                    if (data !== undefined && data.Cuantos !== null) {
                        ...
                        console.log("El campo 'Cuantos' no está definido en el documento 'Celular2'. Se establecerá a 0.");
                        newcuantos = 0;
                    }
                }
            });
            ...
            const datos = {
                ...
                Precio: precio1,
                Nombre:nombre1,
                ID_DOCUMENTO: "Celular2",
                Cuantos: suma,
                Producto:producto
            };
          
            const peticionesRef = collection(nuevoDocRef, 'peticiones');
            const Celular1DocumentoRef = doc(peticionesRef, 'Celular2'); // Aquí defines el nombre del documento
